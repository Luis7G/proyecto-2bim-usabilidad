  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <p className="text-xl leading-relaxed mb-8 text-justify" tabIndex={0}>
        ...
        <p
          className="text-xl leading-relaxed mb-8 text-center font-bold"
          tabIndex={0}
        >
          Nota: Puedes ingresar a cada sección presionando la tecla ENTER
        </p>
      </div>
    </footer>
  );
