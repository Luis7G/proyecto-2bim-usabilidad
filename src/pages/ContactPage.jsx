  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-[#0070c2] flex-grow flex flex-col items-center justify-center">
        <div
          className="bg-white text-black text-6xl font-bold py-2 px-8 rounded-3xl mt-8 mb-28"
          tabIndex={0}
        >
        ...
        <div className="flex justify-around w-full max-w-6xl items-center">
          ...
          <div className="flex flex-col items-center">
            <img
              ...
              tabIndex={0}
              aria-label="Puedes también llamarnos, continúa para escuchar el número"
            />
            <div className="text-white text-3xl font-bold mt-4" tabIndex={0}>
              +1 (555) 123-4567
            </div>
          </div>
        </div>
